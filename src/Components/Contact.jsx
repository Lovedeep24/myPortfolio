  ...
  return (
    <>
        <div className="bg-[#0B0B0B] w-full h-auto flex flex-col-reverse sm:flex-row ">
            <div style={{paddingTop:'6rem', paddingLeft:'4rem',paddingTop: window.innerWidth < 640 ? '1rem' : '6rem', }} className="bg-[#0B0B0B] w-full sm:w-[50%] h-full px-[5rem] pr-[6.75rem] flex flex-col gap-5">
            ...
            <div style={{paddingTop:'10rem', paddingLeft:'4rem',paddingTop: window.innerWidth < 640 ? '3rem' : '10rem', }} className="sm:w-[40%] w-full flex flex-col gap-8">
